...
- **Заголовок (Summary):** кратко и понятно что и где не работает.
- **Шаги (Steps):** пошагово для повторения бага.
- **Ожидаемый (Expected):** что должно произойти.
- **Фактический (Actual):** что реально происходит.
- **Среда (Environment):** браузер, ОС, устройство.

---

> 💡 Хороший баг-репорт даёт разработчику:  
> - возможность быстро воспроизвести ошибку,  
> - понять важность,  
> - сразу локализовать проблему.
